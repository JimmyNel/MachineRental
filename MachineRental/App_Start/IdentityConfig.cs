...
namespace MachineRental
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var mailMessage = SetupMailTemplate(message);
            var smtp = new SmtpClient();

            return smtp.SendMailAsync(mailMessage);
        }

        public MailMessage SetupMailTemplate(IdentityMessage message)
        {
            // Indiquez votre service de messagerie ici pour envoyer un e-mail.
            var mess = new MailMessage();

            mess.BodyEncoding = Encoding.UTF8;
            mess.From = new MailAddress(Constant.EmailSender, Constant.Morel);
            mess.To.Add(message.Destination);
            mess.Subject = message.Subject;
            mess.Body = "<p>Bonjour,</p><br><p>" + message.Body + "</p><br><p>Cordialement</p><br><br>" +
                        "<a href='https://www.enterprise.com' style=\"color:#a3c42f;\">www.enterprise.com</a>";
